...
import (
	...
	parser "github.com/agaabrieel/bittorrent-client/pkg/bencode/parser"
)
...
type TorrentMetainfo struct {
	...
	CreationDate int64
	Author       string
	InfoDict     *TorrentMetainfoDict
	Extra        []parser.BencodeValue
	Infohash     [sha1.Size]byte
}

type TorrentMetainfoDict struct {
	Length      uint64
	Name        string
...
func (t *TorrentMetainfo) Parse(filepath string) error {
...
func (t *TorrentMetainfo) parseInfoDict(entry parser.BencodeDictEntry) error {
